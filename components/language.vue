...
<template>
  <UDropdown :items="items" :popper="{placement: 'bottom-start', arrow:false}" class="text-lg font-bold desktop-dropdown hidden lg:block, xl:block 2xl:block">
    <div class="">
  ...
  <UDropdown :items="items" :popper="{placement: 'bottom-start', arrow:false}" class="text-lg font-bold mobile-dropdown block lg:hidden xl:hidden 2xl:hidden">
   <div class="">
    <UButton class="h-[35px] w-[35px]  bg-white text-[#008000] text-lg hover:bg-white hover:text-[#008000] rounded-full ml-1 mt-[3px]">
